...
--p-exclude $p_exclude \
--o-filtered-table $ANALYSIS_NAME.filtered_table_dn"$p_perc_identity".qza || exit_on_error
...
--i-taxonomy $ANALYSIS_NAME.taxo_dn"$p_perc_identity".qza \
--p-exclude $p_exclude \
--o-filtered-sequences $ANALYSIS_NAME.filtered_rep-seqs-dada2_dn"$p_perc_identity".qza || exit_on_error
...
--o-visualization $ANALYSIS_NAME.filtered_barplots_taxo_dn"$p_perc_identity".qzv || exit_on_error
